...
final class TrialSimulationTest {
    ...
    /**
     * Empowered-run pressure floor. Pairs carry genuine risks the simulator underprices
     * (a potion-ignoring bot fears neither Dry Veins nor Swift Hollow), and affixes grant
     * ambient power to every build, so the pair band centers at 4% while the naked-run
