...
final class TrialSimulationTest {
    ...
    /**
     * Empowered-run pressure floor. Pairs carry genuine risks, and affixes, sets, and
     * forge levels grant ambient power to every build, so the pair band centers at 4%
     * while the naked-run baseline gate keeps its 5%. Phase 26 re-derives every band
     * from the full game.
     */
