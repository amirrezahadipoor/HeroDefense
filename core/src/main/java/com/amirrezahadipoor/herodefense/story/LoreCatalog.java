...
public final class LoreCatalog {
    private static final List<LoreEntry> ALL = Collections.unmodifiableList(Arrays.asList(
        entry(1, "Before You.",
            "Others stood here before you. I do not remember most of their names. I remember all of their last stands.",
        ...
        entry(4, "What Luck Finds.",
            "Some of what falls from them still remembers being useful. Wear it. I would rather you have it than the ground.",
        ...
        entry(6, "Old Names.",
            "Rootling. Stonekin. Gloom Wolf. Fungal Brute. I gave three of those names myself, once, to living things, meaning something kinder.",
        ...
        entry(8, "Two Roots.",
            "I did not ask for a second trunk. I am glad of it regardless. Grief is lighter, split two ways — and so, it turns out, is standing guard.",
        ...
        entry(10, "The Matriarch's Garden.",
            "She is not attacking you with monsters. She is attacking you with her children. I do not say this to trouble you. I say it because you deserve to know what you're ending, and why it still might be a mercy.",
            LoreTrigger.BOSS_FIRST_KILL, "THORN_MATRIARCH"),
        entry(11, "An Ember That Refused.",
            "Fire is supposed to go out. This one refused, and refusal, given enough years, becomes a shape. The Wyrm is that refusal, wearing scales.",
            LoreTrigger.BOSS_FIRST_KILL, "EMBER_WYRM"),
        entry(12, "The Shape of Falling.",
            "I asked the Void Knight, once, in the only language I have — stillness, and time — what it wanted. It did not answer. I don't think it remembers the question anymore. I don't think it remembers much of anything except falling, and wanting company on the way down.",
            LoreTrigger.BOSS_FIRST_KILL, "VOID_KNIGHT"),
        entry(13, "On Letting Go.",
        ...
        entry(15, "The Trail Home.",
            "Every rotting thing wants to return to soil eventually. I only wish this kind of soil grew something other than more of itself.",
        ...
        entry(17, "The Shape of a Habit.",
            "Twice now. I am beginning to recognize your footsteps before I see you. That is not nothing, after this many centuries of forgetting faces.",
            LoreTrigger.ASCENSION, "2"),
        entry(18, "What Doesn't Reset.",
            "The waves start over. The dark starts over. You do not — not all the way. I've watched enough Wardens to know the difference between someone starting fresh and someone simply starting again.",
            LoreTrigger.ASCENSION, "3"),
        entry(19, "A Question I Don't Ask Often.",
        ...
        entry(21, "Bare-Handed",
            "You did that with what you were given, not with what you bought. I don't know whether to call that discipline or stubbornness. Possibly they are the same root.",
        ...
        entry(23, "Mastery, Spent",
            "You have done that thing ten times so precisely that it no longer looks like effort. I remember when standing here felt like that too.",
            LoreTrigger.SECRET, "mastery"),
        entry(24, "Reforged",
            "Nothing stays as it was made. You, least of all. I mean that kindly.",
            LoreTrigger.SECRET, "reforged"),
        entry(25, "Six Mythics",
        ...
        entry(27, "The Long Pause",
            "I do not mind if you leave and come back. I have had centuries of practice at waiting. It is rather a specialty of mine, at this point.",
            LoreTrigger.SECRET, "long_pause"),
        entry(28, "Every Elite, Once",
            "You've heard every fragment I have to whisper through them now. There is more to tell. There is always more. It simply isn't theirs to carry.",
            LoreTrigger.SECRET, "every_elite"),
        entry(29, "Fastest Fall",
            "That was over before the Hollow finished sending it. I don't think it noticed yet.",
            LoreTrigger.SECRET, "fastest_fall"),
        entry(30, "Two Hundred, Once More",
